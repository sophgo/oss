...
#include "cvi_arraylist.h"
#ifndef REMOVE_UNUSED_FUNCTION
struct array_list *array_list_new(array_list_free_fn *free_fn)
{
	return cvi_array_list_new2(free_fn, ARRAY_LIST_DEFAULT_SIZE);
}
#endif
struct array_list *cvi_array_list_new2(array_list_free_fn *free_fn, int initial_size)
{
...
extern void cvi_array_list_free(struct array_list *arr)
{
	size_t i;
...
void *cvi_array_list_get_idx(struct array_list *arr, size_t i)
{
	if (i >= arr->length)
		return NULL;
	return arr->array[i];
...
int cvi_array_list_shrink(struct array_list *arr, size_t empty_slots)
{
	void *t;
	size_t new_size;
...
#endif
int cvi_array_list_add(struct array_list *arr, void *data)
{
...
#endif
size_t cvi_array_list_length(struct array_list *arr)
{
	return arr->length;
}
