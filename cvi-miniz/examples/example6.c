// example6.c - Demonstrates how to cvi_miniz's PNG writer func
...
int main(int argc, char *argv[])
{
  ...
  // Now write the PNG image.
  {
    ...
    // mz_free() is by default just an alias to free() internally, but if you've overridden cvi_miniz's allocation funcs you'll probably need to call mz_free().
    mz_free(pPNG_data);
  }
